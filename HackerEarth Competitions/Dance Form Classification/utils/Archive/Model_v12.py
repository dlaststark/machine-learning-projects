...
def identity_block(x, f, filters, stage, block, dr=0.2, lr=0.2):
    """
...
def convolutional_block(x, f, filters, stage, block, s=2, p=2, dr=0.2, lr=0.2):
    """
