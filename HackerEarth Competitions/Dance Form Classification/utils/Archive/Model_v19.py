...
def cnn_model(input_shape):
    ...
    x = identity_block(x, 3, [16, 16, 32], stage=2, block='C', dm=1)
    ...
    x = identity_block(x, 3, [32, 32, 64], stage=3, block='C', dm=1)
    x = identity_block(x, 3, [32, 32, 64], stage=3, block='D', dm=2)
    ...
    x = identity_block(x, 3, [64, 64, 128], stage=4, block='C', dm=1)
    x = identity_block(x, 3, [64, 64, 128], stage=4, block='D', dm=2)
    ...
    x = identity_block(x, 3, [128, 128, 256], stage=5, block='C', dm=1)
    x = identity_block(x, 3, [128, 128, 256], stage=5, block='D', dm=2)
    x = identity_block(x, 3, [128, 128, 256], stage=5, block='E', dm=4)
    ...
    x = identity_block(x, 3, [256, 256, 512], stage=6, block='C', dm=1)
    x = identity_block(x, 3, [256, 256, 512], stage=6, block='D', dm=2)
    x = identity_block(x, 3, [256, 256, 512], stage=6, block='E', dm=4)
    ...
    x = identity_block(x, 3, [512, 512, 1024], stage=7, block='C', dm=1)
    x = identity_block(x, 3, [512, 512, 1024], stage=7, block='D', dm=2)
    x = identity_block(x, 3, [512, 512, 1024], stage=7, block='E', dm=4)
    x = identity_block(x, 3, [512, 512, 1024], stage=7, block='F', dm=6)
