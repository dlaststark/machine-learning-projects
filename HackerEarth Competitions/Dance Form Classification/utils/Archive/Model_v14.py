...
def cnn_model(input_shape):
    ...
    # Stage 2
    x = convolutional_block(x, f=3, filters=[16, 16, 32], stage=2, block='A')
    x = identity_block(x, 3, [16, 16, 32], stage=2, block='B')
    
    # Stage 3
    x = convolutional_block(x, f=3, filters=[32, 32, 64], stage=3, block='A')
    x = identity_block(x, 3, [32, 32, 64], stage=3, block='B')
    x = identity_block(x, 3, [32, 32, 64], stage=3, block='C')
    
    # Stage 4
    x = convolutional_block(x, f=3, filters=[64, 64, 128], stage=4, block='A')
    ...
    # Stage 5
    x = convolutional_block(x, f=3, filters=[128, 128, 256], stage=5, block='A')
    ...
    x = identity_block(x, 3, [128, 128, 256], stage=5, block='E')
    x = identity_block(x, 3, [128, 128, 256], stage=5, block='F')
    
    # Stage 6
    x = convolutional_block(x, f=3, filters=[256, 256, 512], stage=6, block='A')
    ...
    x = identity_block(x, 3, [256, 256, 512], stage=6, block='E')
    
    # Stage 7
    x = convolutional_block(x, f=3, filters=[512, 512, 1024], stage=7, block='A')
    x = identity_block(x, 3, [512, 512, 1024], stage=7, block='B')
    x = identity_block(x, 3, [512, 512, 1024], stage=7, block='C')
    x = identity_block(x, 3, [512, 512, 1024], stage=7, block='D')
