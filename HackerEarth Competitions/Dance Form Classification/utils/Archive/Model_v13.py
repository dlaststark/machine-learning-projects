...
def cnn_model(input_shape):
    ...
    # Stage 6
    x = convolutional_block(x, f=3, filters=[512, 512, 2048], stage=6, block='A')
    x = identity_block(x, 3, [512, 512, 2048], stage=6, block='B')
    
    # Stage 7
    x = convolutional_block(x, f=3, filters=[1024, 1024, 4096], stage=7, block='A')
    x = identity_block(x, 3, [1024, 1024, 4096], stage=7, block='B')
